        ...
        @if ($canAdminister)
            <div>
                ...
                <div class="space-y-1">
                    ...
                    {{--
                        Global AI, next to Users because it is the same kind of
                        thing: a workspace-wide setting that holds credentials.
                        Behind the same gate the route is.
                    --}}
                    <x-app.nav-link :href="route('admin.ai')" :active="request()->routeIs('admin.ai')">
                        <x-slot:icon>
